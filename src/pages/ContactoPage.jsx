...
*Mensaje:* ${formData.message || 'Sin mensaje'}`.trim();
    ...
    const whatsappUrl = `https://api.whatsapp.com/send?phone=5491163072324&text=${encodedMessage}`;
            ...
            <motion.div initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, delay: 0.4 }} className="space-y-8">
              <div className="bg-white rounded-lg p-8 shadow-lg">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start space-x-4"><Phone className="text-chiamo-green flex-shrink-0 mt-1" size={24} /><div><p className="font-semibold text-chiamo-dark">Teléfono</p><p className="text-chiamo-text">+54 9 11 6307-2324</p></div></div>
                  <div className="flex items-start space-x-4"><Mail className="text-chiamo-green flex-shrink-0 mt-1" size={24} /><div><p className="font-semibold text-chiamo-dark">Email</p><p className="text-chiamo-text">info@chiamo.com.ar</p></div></div>
                </div>
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.6 }} className="mt-8 pt-6 border-t border-gray-200">
                  ...
                  <div className="flex justify-center space-x-6">
                    <a href="https://wa.me/5491163072324" target="_blank" rel="noopener noreferrer" className="transition-transform transform hover:scale-110" aria-label="Contactar a CHIAMO Construcciones por WhatsApp" title="WhatsApp">
                    ...
                    <a href="mailto:info@chiamo.com.ar?subject=Presupuesto" target="_blank" rel="noopener noreferrer" className="transition-transform transform hover:scale-110" aria-label="Contactar a CHIAMO Construcciones por Mail" title="Enviar Mail">
                        <img src="https://sorteomix.com.ar/assets/image/gmail.png" alt="Mail" className="w-10 h-10" />
                    </a>
                    <a href="https://www.instagram.com/chiamo_construcciones?utm_source=qr&igsh=OGw2MGt3ZnB1aXV0" target="_blank" rel="noopener noreferrer" className="transition-transform transform hover:scale-110" aria-label="Seguir a CHIAMO Construcciones en Instagram" title="Instagram">
                    ...
                    <a href="https://www.facebook.com/share/17fbgjG9SR/" target="_blank" rel="noopener noreferrer" className="transition-transform transform hover:scale-110" aria-label="Seguir a CHIAMO Construcciones en Facebook" title="Facebook">
                        <img src="https://horizons-cdn.hostinger.com/8ea8417c-7e84-4d95-89a7-af96163fff02/087fba7899f48f4e4c30d992abd9464f.png" alt="Facebook" className="w-10 h-10" />
                    </a>
                  </div>
                </motion.div>
              </div>
